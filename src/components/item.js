...
export default function (item) {
  ...
  const head = new ElementBuilder("div").addClass("todo-header").build();

  const leftside = new ElementBuilder("div").addClass("todo-item-left").build();
  ...
  itemData.append(
    new ElementBuilder("h3").setText(item.title).addClass("todo-title").build(),
  ...
  details.append(
    new ElementBuilder("p").addClass("details-desc").setText(item.desc).build(),
  );
